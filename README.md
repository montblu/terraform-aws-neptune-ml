...
| <a name="input_cluster_instance_count"></a> [cluster\_instance\_count](#input\_cluster\_instance\_count) | Number of instances to run in Neptune cluster. | `number` | `1` | no |
